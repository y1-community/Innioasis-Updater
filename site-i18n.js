...
(function () {
    ...
    var RULES = [
        ...
        ["Firmware questions", "Soft questions"],
        ...
        ["Coming back from Rockbox or another custom firmware uses the same Updater flow: select your model, choose Original Software, and run Install / Restore.", "Coming back from Rockbox or another custom soft is the same Updater flow: pick your model, choose Original Software, and run Install / Restore."],
        ...
        ["Innioasis.app — the site for Updater Community Edition — does not use cookies or browser fingerprinting. We remember your site theme, and only the preferences you allow.", "Innioasis.app — the deck for Updater Community Edition — runs no cookies and no fingerprinting. We keep your deck theme, and only the prefs you allow."],
        ...
        ["Used on the firmware directory.", "Used on the soft directory."],
        ["Your site theme is always remembered — it is the look you chose. Links to GitHub, YouTube, Discord, Ko-fi, PayPal, Revolut, and Patreon open those sites' own pages, which have their own policies.", "Your deck theme is always kept — it's the look you picked. Links to GitHub, YouTube, Discord, Ko-fi, PayPal, Revolut, and Patreon open those sites' own pages, which run their own policies."],
        ...
        ["firmware installation changes system software. Keep the cable connected until Updater says it is safe to disconnect.", "soft install changes the system software. Keep the datalink connected until Updater says it is safe to unplug."],
        ...
        ["do not try to remove folders or change hidden files first. The stock restore is a firmware install, so let Updater replace the system software for you.", "do not try to remove folders or touch hidden files first. The stock restore is a soft install, so let Updater replace the system for you."],
        ...
        /* Generic firmware guide (firmware-guide.html) */
        ["Firmware installation guide", "Soft install run"],
        ["Install a listed firmware on your Innioasis Y1 or Y2", "Install a listed soft on your Innioasis Y1 or Y2"],
        ...
        ["Browse firmware by model", "Browse soft by rig"],
        [" or another listed custom firmware with Updater: choose the model printed on your player, select ", " or another listed custom soft with Updater: pick the model printed on your rig, select "],
        [". The stock restore is a firmware install, so Updater replaces the system software for you.", ". The stock restore is a soft install, so Updater replaces the system software for you."],
        /* Firmware FAQ: what each route gives you */
        ...
        ["No firmware project is currently listed for this model and filter. Try another project or check the project release pages.", "Nothing is on the board for that rig and filter. Try another soft or check the project's drop pages."],
        /* Rockbox */
        ["Getting Rockbox on your Y1 or Y2", "Getting Rockbox on your Y1 or Y2"],
        ["What the install changes", "What the flash changes"],
        ["Rockbox is custom firmware. It does not remove your ability to return to the stock interface when the matching Original Software package is available.", "Rockbox is custom soft. It does not remove your ability to return to the stock interface when the matching Original Software drop is available."],
        ...
        ["Homebrew website", "Homebrew website"],
        ["Mac downloads", "Mac downloads"],
        ...
        /* FAQ */
        ["Firmware questions answered", "Soft questions answered"],
        ["Which Innioasis firmware route is right for you?", "Which Innioasis soft route is yours?"],
        ...
        ["Listings can change.", "The board changes."],
        ["The live Updater catalogue and each project’s release notes are the authority for what is installable today.", "The live Updater catalogue and each project's drop notes are the authority for what is installable today."],
        ...
        ["Base ROMs give custom firmware developers a clean Android foundation with the wireless radio chips enabled. They keep the original factory radios too, so a custom build can use Wi-Fi, GPS, and FM alongside the Bluetooth and FM the players shipped with.", "Base shards give custom soft devs a clean Android foundation with the wireless radio chips firing. They keep the factory radios too, so a custom build can use Wi-Fi, GPS, and FM alongside the Bluetooth and FM the rigs shipped with."],
        ...
        ["Firmware projects, themes, tools, and device testing all help the ecosystem move forward.", "Soft projects, themes, tools, and device testing all push the ecosystem forward."],
        ...
        ["Publishing a custom firmware? Read the developer guide for adding Y1 and Y2 releases to Updater.", "Shipping a custom soft? Read the dev guide for adding Y1 and Y2 drops to Updater."],
